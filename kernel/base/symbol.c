...
unsigned long symbol_lookup_name(const char *name)
{
    ...
    if(yukisu_compact_find_symbol) {
        return yukisu_compact_find_symbol(name);
    }
...
void symbol_init()
{
    ...
    yukisu_compact_find_symbol = (typeof(yukisu_compact_find_symbol)) kallsyms_lookup_name("yukisu_compact_find_symbol");
}